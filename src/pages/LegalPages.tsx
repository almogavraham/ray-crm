...
import { SITE_LEGAL, hasLegalEntity } from '../lib/siteLegal';
...
function Terms() {
  return (
    <>
      ...
      <H>תשלומים וביטול</H>
      <P>
        תנאי התשלום, המסלולים והמחירים מוצגים בעמוד התמחור. ניתן לבטל מנוי בכל עת;
        הביטול ייכנס לתוקף בתום תקופת החיוב הנוכחית. ביטול עסקה יתאפשר בהתאם לחוק הגנת
        הצרכן, התשמ״א-1981.
      </P>
