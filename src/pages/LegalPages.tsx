...
function Terms() {
  return (
    <>
      ...
      <H>גיל מינימלי לרכישה</H>
      <P>
        השירות מיועד לשימוש עסקי. תנאי לביצוע רכישה באתר הוא שהרוכש הינו בן 18 שנים
        ומעלה ובעל כשירות משפטית להתקשר בהסכם מחייב, או תאגיד רשום הפועל באמצעות מי
        שמוסמך לחייב אותו. רכישה על ידי קטין תבוטל, והתמורה תוחזר.
      </P>
      ...
      <P>
        המפעיל ו/או מי מטעמו לא יהיו אחראים לנזק ישיר או עקיף שייגרם כתוצאה משימוש
        בשירות, לרבות אובדן נתונים, אובדן הכנסה או פגיעה במוניטין. התכנים המוצגים
        במערכת אינם מהווים ייעוץ מקצועי, משפטי, חשבונאי או שיווקי, והאחריות על
        השימוש בהם ועל ההחלטות המתקבלות בעקבותיהם היא של המשתמש בלבד. האחריות לגיבוי
        נתונים המוזנים למערכת ולבדיקת תקינותם היא של המשתמש, מבלי לגרוע מהגיבויים
        שאנו מבצעים מצדנו.
      </P>
      ...
      <H>אספקת השירות</H>
      <P>
        RAY CRM הוא שירות תוכנה מקוון (SaaS). אין משלוח פיזי ואין דמי משלוח. הגישה
        לשירות נפתחת <strong>מיידית עם אישור התשלום</strong>, ולא יאוחר משעה אחת ממנו,
        ונמסרת באופן אלקטרוני בלבד: פרטי ההתחברות והחשבונית נשלחים לכתובת הדוא״ל
        שנמסרה בעת הרכישה.
      </P>
      <P>
        השירות זמין בכל דפדפן מודרני ואינו דורש התקנה. אם לא התקבלה גישה תוך שעה
        מהתשלום, יש לפנות אלינו והנושא יטופל בהקדם; לא נגבה תשלום נוסף בגין עיכוב
        באספקה שנגרם מצדנו.
      </P>
