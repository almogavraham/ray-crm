            ...
            <>
              {branding.logoUrl ? (
                <img
                  ...
                  alt={branding.name}
                  className="w-12 h-12 rounded-2xl object-contain bg-white p-1 shadow-lg"
                />
              ) : (
              ...
              <div>
                <p className="text-white font-black text-2xl leading-tight">{branding.name}</p>
                <p className="text-slate-500 text-xs font-medium -mt-0.5">מופעל על ידי RAY CRM</p>
              </div>
            </>
          ) : (
            /* Default RAY branding */
            <>
              <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center shadow-lg shadow-indigo-500/40">
